...
const TOOL_META: Record<ToolId, { title: string; description: string }> = {
  decrypt: {
    title: "AES-CBC 256 Decrypt",
    description: "Decrypt Base64-encoded cipher text",
  },
  encrypt: {
    title: "AES-CBC 256 Encrypt",
    description: "Encrypt plain text with AES-CBC 256",
  },
  formatter: {
    title: "JSON Formatter",
    description: "Format, prettify, or stringify JSON",
  },
  compare: {
    title: "JSON Compare",
    description: "Diff two JSON objects side-by-side",
  },
  schema: {
  ...
  base64: {
    ...
    description: "Encode text to Base64 (btoa) or decode Base64 to text (atob)",
  },
  jsonserialize: {
    title: "JSON Serialize / Deserialize",
    description:
      "Serialize objects to JSON strings and deserialize JSON strings to objects",
  },
  charcounter: {
  ...
  codetostring: {
    title: "Code to String",
    description: "Escape and wrap code into a string literal",
  },
};
