...
export function CharCounterPage() {
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="font-mono text-sm min-h-[120px] sm:min-h-[180px] resize-y"
          autoFocus
        />
      </div>
      ...
      <div className="flex items-center gap-2">
        <Switch id="freq" checked={showFreq} onCheckedChange={setShowFreq} />
